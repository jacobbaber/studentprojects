...
/**
 * This class automates the evolution of Generations by calling on it's
 * aggregated methods. It also saves the evolved Generations to a file and can
...
public abstract class Automaton {
	...
	/**
	 * falseSymbol is a char value that is used to symbolize a false boolean element
	 * of a cell
	 */
	public char falseSymbol;
	/**
	 * trueSymbol is a char value that is used to symbolize a true boolean element
	 * of a cell
	 */
	public char trueSymbol;

	/**
	 * Constructor for class Automaton which takes in the ruleNum to create a new
	 * Rule object, and a Generation to add to the ArrayList of generations. It also
	 * intializes falseSymbol and trueSymbol to their default values 0 and 1.
	 * 
	...
	/**
	 * This constructor for class Automaton reads a file that contains the rule
	 * number, the true and false symbols, and a String of the first generation
	 * using the true and false symbols. After getting the values from the file, it
	 * converts the String of true and false symbols to a boolean array, and then
	 * uses that array to create the initial Generation, and then adds that
	 * Generation to the Array List of Generations.
	 * 
	...
	/**
	 * This method evolves a Generation according to the rule a numSteps number of
	 * times and saves each new Generation to the Generation array list
	 * 
	 * @param numSteps, integer value for the number of times a generation should be
	 *                  evolved
	 */
	...
	/**
	 * This method gets the Generation in the Generation arrayList at the index of
	 * stepNum. If the Generation arrayList hasn't gotten to the step at stepNum, it
	 * will evolve the Generations to that step.
	 * 
	...
	/**
	 * This method returns the int value of the rule number for the Rule object
	 * being used
	 * 
	...
	/**
	 * this method returns the total times the intial generation has evolved, which
	 * is the arraylist's total size - 1
	 * 
	...
	/**
	 * This method writes the toString method to a file, which saves each
	 * generation.
	 * 
	...
	/**
	 * Overrides the toString method. It converts each generation to a String
	 * represented by the falseSymbol and trueSymbols. With each generation
